...
<head>
    <meta charset="UTF-8">
    <title>Register - SDG 3 Health Dashboard</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-[#eef4f9] flex items-center justify-center min-h-screen" style="background-image: url('images/background.png'); background-size: cover; background-position: center;">
    ...
    <div class="w-full max-w-md bg-white p-10 rounded-2xl shadow-lg">
        ...
        <h2 class="text-2xl font-bold text-center mb-6 text-gray-800">Registration</h2>
